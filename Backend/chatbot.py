# Reconstructing the full chatbot script with updated `check_memory` and Groq integration for human-like responses
...
if __name__ == "__main__":
    init_files()
    # print(f"is now active. Type 'exit' to quit.\n")
    while True:
